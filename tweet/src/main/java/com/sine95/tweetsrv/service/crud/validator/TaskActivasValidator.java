...
public class TaskActivasValidator implements IValidator< TaskActivas >  {
...
protected List<ISingleValidator> validadoresUpdate=new ArrayList<ISingleValidator>();
	...
	protected TaskActivasServiceCRUD servicio = null;

	public TaskActivasValidator(TaskActivasServiceCRUD servicio) {
		super();

		genValidadoresDefectoCampoId();

		genValidadoresDefectoCampoTarea();

		genValidadoresDefectoCampoActiva();
		...
		private void genValidadoresDefectoCampoId()
		{
			...
			ISingleValidator obligatorio=new ObligatorioValidator("TaskActivas","id");
		...
		private void genValidadoresDefectoCampoTarea()
		{
			...
			ISingleValidator obligatorio=new ObligatorioValidator("TaskActivas","tarea");
			...
			validadoresUpdatePorCampo.put("tarea", lstUpdate);
			validadoresInsertPorCampo.put("tarea", lstInsert);
			validadoresUpdate.addAll(lstUpdate);
			validadoresInsert.addAll(lstInsert);
		}

		private void genValidadoresDefectoCampoActiva()
		{
			List<ISingleValidator> lstUpdate=new ArrayList<ISingleValidator>();
			List<ISingleValidator> lstInsert=new ArrayList<ISingleValidator>();

			ISingleValidator obligatorio=new ObligatorioValidator("TaskActivas","activa");
			...
			validadoresUpdatePorCampo.put("activa", lstUpdate);
			validadoresInsertPorCampo.put("activa", lstInsert);
			validadoresUpdate.addAll(lstUpdate);
			validadoresInsert.addAll(lstInsert);
		}
...
@Override
	public List<IError> validateInsert(TaskActivas obj) {
	...
	@Override
	public List<IError> validateUpdate(TaskActivas obj) {
		List<IError> res=new ArrayList<IError>();
	...
	@Override
	public List<IError> validateDelete(TaskActivas obj) {
		List<IError> res=new ArrayList<IError>();
	...
	private List<IError> validateUpdateDefecto(TaskActivas obj) {
		List<IError> res=new ArrayList<IError>();
	...
	private List<IError> validateInsertDefecto(TaskActivas obj) {
		List<IError> res=new ArrayList<IError>();
