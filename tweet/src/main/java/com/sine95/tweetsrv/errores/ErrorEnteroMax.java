...
public class ErrorEnteroMax implements IError
{

  protected Map<String,String> params=new HashMap<>();
  protected Set<EnumCategoriasErrores> categorias=new HashSet<>();

  private static Logger log = LoggerFactory.getLogger(ErrorEnteroMax.class);
 
  //Code:VAL_ENTERO_MAX
   
  public ErrorEnteroMax(
  ...
  , "valor", valor
    ...
    if (log.isErrorEnabled()) {
	    log.error("Entrando en ErrorEnteroMax ("+_params_+"):"+UtilString.toString(stackTrace));
    }
  ...
  {
    return UtilError.genMsg("La clase ((clase)) tiene en el campo ((campo)) un valor mayor que ((valor))",getParams());  
  }

	public String getCode(){
    return "VAL_ENTERO_MAX";
  }
