...
public class ErrorDecimalEscala implements IError
{

  protected Map<String,String> params=new HashMap<>();
  protected Set<EnumCategoriasErrores> categorias=new HashSet<>();

  private static Logger log = LoggerFactory.getLogger(ErrorDecimalEscala.class);
 
  //Code:VAL_DECIMAL_ESCALA
   
  public ErrorDecimalEscala(
  ...
  , "escala", escala
    ...
    if (log.isErrorEnabled()) {
	    log.error("Entrando en ErrorDecimalEscala ("+_params_+"):"+UtilString.toString(stackTrace));
    }
    ...
    if(campo!=null)
      ...
      params.put("escala",Integer.toString(escala));
  ...
  {
    return UtilError.genMsg("La clase ((clase)) tiene en el campo ((campo)) una escala (n?mero de dígitos de la parte decimal) mayor de la soportada: ((escala)) dígitos",getParams());  
  }

	public String getCode(){
    return "VAL_DECIMAL_ESCALA";
  }
