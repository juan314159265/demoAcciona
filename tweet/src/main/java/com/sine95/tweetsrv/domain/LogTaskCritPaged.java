...
@SuppressWarnings("unused")
 public class LogTaskCritPaged extends LogTaskCrit implements Pageable, Serializable {
   ...
   private Sort sort;
	...
	{
		return "LogTaskCritPaged{ "+super.toString()+
			", Pageable{" +
	...
	public LogTaskCritPaged()
	{
		super();
	}
	
	public LogTaskCrit getCrit()
	{
		return this;
	}
