...
@SuppressWarnings("unused")
 public class TaskActivasCritPaged extends TaskActivasCrit implements Pageable, Serializable {
   ...
   private Sort sort;
	...
	{
		return "TaskActivasCritPaged{ "+super.toString()+
			", Pageable{" +
	...
	public TaskActivasCritPaged()
	{
		super();
	}
	
	public TaskActivasCrit getCrit()
	{
		return this;
	}
