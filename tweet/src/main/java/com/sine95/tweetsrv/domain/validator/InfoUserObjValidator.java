...
public class InfoUserObjValidator implements IValidatorObj< InfoUser >  {

	protected ApplicationContext appContext;

	protected List<ISingleValidator> validadores=new ArrayList<ISingleValidator>();
	
	public InfoUserObjValidator(ApplicationContext _appCont) {
		super();
		...
		private void genValidadoresDefectoCampoLogin()
		{
            ...
            ISingleValidator cadena=new CadenaValidator("InfoUser","login", 50);
			...
			ISingleValidator obligatorio=new ObligatorioValidator("InfoUser","login");
		...
		private void genValidadoresDefectoCampoEmail()
		{
            ...
            ISingleValidator cadena=new CadenaValidator("InfoUser","email", 254);
		...
		private void genValidadoresDefectoCampoFirst_name()
		{
            ...
            ISingleValidator cadena=new CadenaValidator("InfoUser","first_name", 50);
		...
		private void genValidadoresDefectoCampoLast_name()
		{
            ...
            ISingleValidator cadena=new CadenaValidator("InfoUser","last_name", 50);
		...
		private void genValidadoresDefectoCampoImage_url()
		{
            ...
            ISingleValidator cadena=new CadenaValidator("InfoUser","image_url", 256);
		...
		private void genValidadoresDefectoCampoLang_key()
		{
            ...
            ISingleValidator cadena=new CadenaValidator("InfoUser","lang_key", 6);
	...
	@Override
	public List<IError> validate(InfoUser obj) {
	...
	private List<IError> validateDefecto(InfoUser obj) {
		List<IError> res=new ArrayList<IError>();
